  ...
  if (success) {
    return (
      <div className="max-w-[800px] mx-auto p-12 text-center bg-white border border-[#DEE2E6] rounded-sm shadow-xl">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Club Registered!</h2>
        <p className="text-gray-600 mb-8">Your club application has been submitted successfully. Our team will contact you soon.</p>
